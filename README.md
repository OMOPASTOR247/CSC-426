...
**Live login app:** https://oluwa.rf.gd/
...
```
.
├── calculator/        Java Swing calculator (desktop app)
│   ├── Calculator.java
│   └── README.md
...
## 1. Calculator (Java Swing desktop app)
...
Requirements: JDK 17 or newer (it was checked on OpenJDK 21).
